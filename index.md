# [목차]
- [\[목차\]](#목차)
- [\[게임명 : Overcome\]](#게임명--Overcome)
- [\[컨셉\]](#컨셉)
  - [메인컨셉 : 환경 복구](#메인컨셉--환경복구)
    - [서브 컨셉 1 : 청소](#서브-컨셉-1--청소)
    - [서브 컨셉 2 : 대화](#서브-컨셉-2--대화)
    - [서브 컨셉 3 : 주변 환경](#서브-컨셉-1--주변환경)
    - [서브 컨셉 4 : 간편한 조작, UI](#서브-컨셉-1--간편한조작,UI)
    - [서브 컨셉 5 : Low Poly 그래픽](#서브-컨셉-5--LowPoly그래픽)
- [\[관련 이미지 \& 동영상\]](#관련-이미지--동영상)
- [\[대표 이미지\]](#대표-이미지)
- [\[컨셉 \& 대표이미지 기반 작품묘사\]](#컨셉--대표이미지-기반-작품묘사)
- [\[Overcome의 구성요소\]](#Overcome의-구성요소)
  - [1. 메커니즘](#1-메커니즘)
  - [2. 이야기](#2-이야기)
  - [3. 미적요소](#3-미적요소)
  - [4. 기술](#4-기술)
...
이겨내다라는 의미를 가진 영어단어인 Overcome을 사용하여 모두 함께 지구의 기후위기를 극복하자는 의미
...
<img src=""C:\Users\99kim\Desktop\대표이미지1.png"" width="640" height="480"><br>
게임 플레이 이미지1
...
# [컨셉 & 대표이미지 기반 작품묘사]
> ### 대표이미지 기반
지구온난화 수치를 완화시켜 플레이어의 전투력을 높이며, 호감도 점수를 쌓아 펭귄마을의 신뢰도를 높여 스토리를 진행.

> ### 컨셉 기반
점점 강해지는 플레이어의 전투력과 획득한 아이템을 활용해 전투를 원활하게 진행, 발전해가는 마을의 배경을 실시간으로 확인이 가능.
<br><br>
...
[도전 과제]
- 지구온난화와 기후환경에 해로운 각종 대기 오염 물질과의 전투.
- 스테이지 내에서 획득 가능한 병, 캔, 고철, 플라스틱을 수집하여 펭귄마을 재활용 센터에서 아이템으로 교환.
- 지구온난화 수치가 안좋아질 수록 강한 적이 생성.
- 분리수거를 통해 펭귄마을의 신뢰도 점수의 상승과 하락.
- 아이템과 별개로 지구온난화 수치가 호전되면 플레이어의 전투력이 상승.

[재미 요소]
- 실제 지구의 처한 위기를 게임적인 재미로 각색하여 사람들이 지구온난화에 대한 생각을 다시 가질 수 있게 하는 재미
- 실제에서 우리가 할 수 있는 것들을 퀘스트로 만들어 재미있고, 실천 가능하다는 것을 알게되는 재미
<br>

## 2. 이야기

지구온난화의 가속화로 인해, 6차 대멸종에 가까워진 지구. 인간이 이를 해결하지 않고 방치하려 하자 북극곰들 무리에서는 타임머신을 개발해 과거로 이동해 지구온난화를 해결하고자 하는 움직임이 생겼다.
타임머신을 타게 된 북극곰(이하 플레이어)이 과거의 남극으로 향했다. 이곳에서 문제를 해결하고자했으나 펭귄들은 처음보는 생명체인 플레이어의 이야기를 쉽사리 믿지 못한다.
플레이어가 펭귄 마을의 펭귄들을 설득하려 돌아다니던 중, 마을에서 괴짜로 소문난 한 펭귄을 만나게 된다.
그 펭귄은 다른 펭귄들과 달리 현재 지구가 처한 위기에 대하여 동의하며, 미래를 대비해야한다는 생각에 동조하게된다.
그렇게 괴짜 펭귄과 플레이어는 함께 지구를 지키기 위한 움직임이 시작된다.
