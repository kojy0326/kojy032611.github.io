...
### 서브 컨셉 2 : 대화
- 플레이어가 NPC들과 대화를 함으로써 현재 처한 기후위기를 깨닫는 수단

### 서브 컨셉 3 : 주변 환경
- 플레이어가 스토리를 진행할수록 점점 깨끗해지는 환경을 볼 수 있게 함
- 주변 환경이 바뀜으로써 진행도를 체크할 수 있음

### 서브 컨셉 4 : 간편한 조작
- 간편한 조작은 접근성을 높히고 플레이어가 게임을 부담없이 플레이 수 있게함
- 마우스로 화면을 전환하고 키보드를 통해 플레이어의 이동과 상호작용을 할 수 있게함

### 서브 컨셉 5 : Low Poly 그래픽
- 아기자기한 그래픽을 통해 기후위기라는 무거운 주제를 쉽게 다가갈 수 있게함
